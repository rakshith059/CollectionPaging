...
class TitleInsideImageViewHolder(val view: View?) : BaseTitleInsideImageBlockSectionViewHolder(view) {
    override fun bind(collectionItem: Story, collectionAssociatedMetadata: AssociatedMetadata?, listner: View.OnClickListener) {
        ...
        var ivHeroImage = view?.findViewById<SimpleDraweeView>(R.id.title_inside_image_header_row_iv_hero_icon)

        var clMainContainer = view?.findViewById<ConstraintLayout>(R.id.title_inside_image_header_row_cl_main_container)
