...
open class BaseTitleBelowImageUnderlineSectionViewHolder(itemView: View?) : RecyclerView.ViewHolder(itemView) {
    ...
    open fun bind(collectionItem: Story, collectionAssociatedMetadata: AssociatedMetadata?) {
        ...
        var rbCustomRatingBar = view?.findViewById<CustomRatingBar>(R.id.item_rating_bar)
