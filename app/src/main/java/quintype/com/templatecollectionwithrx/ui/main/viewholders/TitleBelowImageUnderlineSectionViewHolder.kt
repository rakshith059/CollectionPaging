...
class TitleBelowImageUnderlineSectionViewHolder(itemView: View?) : RecyclerView.ViewHolder(itemView) {
    ...
    fun bind(collectionItem: Story, collectionAssociatedMetadata: AssociatedMetadata?) {
        ...
        var tvTitle = itemView?.findViewById<TextView>(R.id.section_underline_title_author_row_tv_title)

        var llUnderlineSection = itemView?.findViewById<LinearLayout>(R.id.section_underline_title_author_row_ll_section)
        var tvSection = itemView?.findViewById<TextView>(R.id.section_underline_title_author_row_tv_section_name)

        var clSectionBlockMainContainer = itemView?.findViewById<ConstraintLayout>(R.id.section_underline_title_author_row_main_container)
        ...
        var mCustomRatingBar = itemView?.findViewById<CustomRatingBar>(R.id.item_rating_bar)
...
//        mSectionBlockTitleAuthorFragment?.setAssosiatedMetaData(ivHeroImage?.context as Context, collectionAssociatedMetadata, collectionItem)
        ...
        mCustomRatingBar?.visibility = View.VISIBLE
        var ratingValue = 3
        mCustomRatingBar?.score = ratingValue.toFloat()
