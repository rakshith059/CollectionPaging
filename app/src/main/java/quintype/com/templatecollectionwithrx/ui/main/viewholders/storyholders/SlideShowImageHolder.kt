...
class SlideShowImageHolder(itemView: View?) : RecyclerView.ViewHolder(itemView) {
    ...
    companion object {
        ...
        fun create(view: View, mImageWidth: Int, height: Int?): SlideShowImageHolder {
            ...
            slideShowImageHolder.ivSlideShowImage?.layoutParams = Utilities.createLayoutParams(slideShowImageHolder.ivSlideShowImage as SimpleDraweeView, mImageWidth, panelHeight)
...
//            panel.layoutParams = params
    ...
    fun bind(storyElement: StoryElement) {
        ...
        ivSlideShowImage?.setImageURI(heroImageURL)
